...
\begin{itemize}
	...
	\item Digital resources like the SUTD Assistive Maps (SAM) Telegram bot \citep{sam} often fail on noisy input (e.g. strings with typos).
\end{itemize}
\end{frame}
...
\end{definition}
\begin{itemize}
	\item We define a 60\% ANSI QWERTY en-US keyboard layout \citep{qwerty}.
\end{itemize}
\end{frame}
...
\end{definition}
\begin{itemize}
	\item Our denoiser is a Nanochat-parameterised \citep{nanochat}, character-level transformer of depth 2 with decoding constrained to the character-level trie induced by $R$.
	\begin{itemize}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{app.png}
...
\begin{frame}
\begin{itemize}
	\item To further improve user experience by making our web application more efficient and responsive, we implemented:
	\begin{itemize}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.4\linewidth]{sam.png}
	\caption{SAM.}
\end{figure}
\begin{itemize}
